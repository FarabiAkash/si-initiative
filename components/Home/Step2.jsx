...
const Step2 = ({ formData, handleData, next, back, loading = false }) => {
  const formattedDate = (() => {
      ...
      <div className='flex justify-between items-center'>
        ...
        <div className='flex items-center gap-4'>
          <button
            ...
            onClick={back}
            disabled={loading}
            className='text-gray-500 font-medium disabled:opacity-70 disabled:cursor-not-allowed'
          >
            Back
          </button>
          <button
            ...
            onClick={next}
            disabled={loading}
            className='bg-[#00C2FF] text-white px-6 py-2 rounded-full font-semibold disabled:opacity-70 disabled:cursor-not-allowed'
          >
