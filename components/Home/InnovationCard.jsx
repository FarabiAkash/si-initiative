const InnovationCard = () => {
  return (
    <div className='2xl-custom:w-[1580px] 2xl-custom:mx-auto custom-container'>
      <div className='bg-primary rounded-lg  sm:mt-10 sm:mb-24 shadow-lg relative '>
        <div className='w-full flex flex-col xl:flex-row justify-center items-center gap-4 py-10 xl:py-16 px-12'>
          ...
          <div className='flex flex-col justify-start items-start'>
            ...
            <p className='text-white text-[18px] leading-[28px] h-auto xl:h-[120px] w-auto xl:w-[700px]'>
              Exploring the frontiers of digital healthcare through
              groundbreaking research and innovative solutions. From AI-driven
              diagnostics to accessible virtual care, our projects aim to
              transform healthcare delivery, improve patient outcomes, and
              bridge critical gaps in medical services.
            </p>
          </div>
        </div>
        {/* Decorative Lines */}
