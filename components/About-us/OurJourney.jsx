...
const OurJourney = () => {
  return (
    <div className='custom-container bg-titleSubtitle text-white  flex flex-col justify-center items-center gap-10 lg:gap-20'>
      ...
      <div className='flex flex-col justify-center text-center lg:px-44 text-white'>
        ...
        <p className='text-center text-[20px] font-[400] leading-[32px]'>
          ...
          global impact, ensuring that technology continues to shape a healthier
          future.
        </p>
